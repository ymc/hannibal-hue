...
setup(
  name = "hannibal",
  version = "0.1",
  url = 'http://github.com/sentric/hannibal',
  description = 'Hue Hannibal integration',
  author = 'Nils Kuebler',
  packages = find_packages('src'),
  package_dir = {'': 'src'},
  install_requires = ['setuptools', 'desktop'],
  entry_points = { 'desktop.sdk.application': 'hannibal=hannibal' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'hannibal': expand_package_data(
      ["src/hannibal/templates", "src/hannibal/static"],
      "src/hannibal/")
  }
)
